...
class AssignmentSubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment_submission" do
    assert_difference('AssignmentSubmission.count') do
      post assignment_submissions_url, params: { assignment_submission: { assignment_id: @assignment_submission.assignment_id, body: @assignment_submission.body, grade: @assignment_submission.grade, user_id: @assignment_submission.user_id } }
    end
  ...
  test "should update assignment_submission" do
    patch assignment_submission_url(@assignment_submission), params: { assignment_submission: { assignment_id: @assignment_submission.assignment_id, body: @assignment_submission.body, grade: @assignment_submission.grade, user_id: @assignment_submission.user_id } }
